package top.funning.app.service.identify.password.android;
...
public class C1023 extends FnService {
    ...
    protected void run() throws Exception {
        ...
        User user = userDAL.getUserByPhone(phone, header.shopId);
        if (user == null) {
            Redis.del(smsCodeId);
            createError(this, "手机号不存在");
            return;
        }
